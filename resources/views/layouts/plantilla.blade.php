...
<body>
    ...
    <div class="menu">
        ...
        <div class="list-container">
            <ul class="list">
                <li class="btn">
                    <a href="{{route('home')}}" class="activo">INICIO</a>
                </li>
                <li class="btn">
                    <a href="{{route('destinos.index')}}" class="activo">DESTINOS</a>
                </li>
                ...
                @endisset
                <li class="btn">
                    <a href="#Nosotros_id" class="activo">NOSOTROS</a>
                </li>
                ...
                @if (auth()->user()->id)
                <li class="btn">
                    <a href="{{route('Viewboletas.index')}}" class="activo">BOLETOS</a>
                </li>
                @endif
                @endisset
                <li class="btn">
                    <a href="" class="activo"><i class="fas fa-user"></i> Usuario</a>
                    <ul>
                        <!-- Authentication Links -->
                        @guest
                        @if (Route::has('login'))
                        <li class="btn2"><a class="activo" href="{{ route('login') }}">
                                <p>{{ __('Iniciar') }}</p>
                            </a></li>
                        @endif

                        @if (Route::has('register'))
                        <li class="btn2"><a class="activo" href="{{ route('register') }}">
                                <p>{{ __('Registrarse') }}</p>
                            </a></li>
                        @endif
                        @else
                        ...
                        <li class="btn2">
                            <a class="activo" href="{{ route('logout') }}" onclick="event.preventDefault();
    ...
    <footer id="Nosotros_id" class="footer" id="contac">
        <div class="wave" style="height: 150px; overflow: hidden;"><svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;">
                <path d="M-2.82,119.89 C60.38,187.98 370.77,22.20 500.56,127.78 L500.00,0.00 L0.00,0.00 Z" style="stroke: none; fill: #dedede;"></path>
            </svg>
        </div>
        <div class="container-footer-all">
            <div class="container-body">
                ...
                <div class="colum2">
                    ...
                    <div class="row">
                        <a href="" target="_blank"><i class="icon fab fa-facebook"></i></a>
                ...
                <div class="colum3">
                    ...
                    <div class="row2">
                        ...
                        <label for="">+51 912345678</label>
                    </div>
                    <div class="row2">
                        <i class="icon fas fa-envelope"></i>
                        <label for="">example@mail.com</label>
                    </div>
                </div>
            </div>
